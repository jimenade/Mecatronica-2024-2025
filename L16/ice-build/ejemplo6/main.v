...
module main #(
 ...
 localparam p2 = vc30b1e;
 localparam p4 = v30ea05;
 localparam p5 = vddb82f;
 wire [0:7] w0;
 wire w1;
 wire w3;
 wire [0:2] w6;
...
//---------------------------------------------------
//-- 3-bits-Mux-2-1-verilog
//-- - - - - - - - - - - - - - - - - - - - - - - - --
//-- 2-to-1 Multplexer (3-bit channels). Verilog implementation
//---------------------------------------------------

module v26eab7_v4d0636 (
 input [2:0] i1,
 input [2:0] i0,
 input sel,
 output [2:0] o
