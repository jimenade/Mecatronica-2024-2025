...
//---- Top entity
module main #(
 parameter v056a5b = 240000,
 parameter v91966e = "v91966e.list"
) (
 input v16f16b,
 input vclk,
 output v11371d,
 ...
 localparam p0 = v056a5b;
 localparam p3 = v91966e;
 wire w1;
 wire w2;
 wire [0:2] w4;
 wire w5;
...
//-- mi-tabla3-32
//-- - - - - - - - - - - - - - - - - - - - - - - - --
//-- Circuito combinacional de 3 entradas y 32 salidas
//---------------------------------------------------

module vb04126_v361fe9 #(
 parameter DATA = 0
) (
 input [2:0] i,
 output [31:0] q
